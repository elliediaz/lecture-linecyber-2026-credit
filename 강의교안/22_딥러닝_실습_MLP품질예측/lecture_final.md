...
| 항목 | 내용 |
|------|------|
| **과제 파일** | `실습과제/Q5_MLP_품질예측.md` |
| **참조 노트북** | `실습과제/Q5_MLP_품질예측.ipynb` |
| **난이도** | ★★★☆☆ (중급) |

#### 과제 내용
1. StandardScaler로 데이터 정규화
2. Sequential 모델 설계 (입력층 → Dense(32) → Dropout(0.3) → Dense(16) → 출력층)
3. compile(optimizer='adam', loss='binary_crossentropy')
4. fit()으로 학습 (validation_split=0.2, epochs=50)
5. 학습/검증 손실 그래프 시각화 및 과적합 진단
