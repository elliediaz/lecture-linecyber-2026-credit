...
| 항목 | 내용 |
|------|------|
| **과제 파일** | `실습과제/Q3_의사결정나무_분류.md` |
| **참조 노트북** | `실습과제/Q3_의사결정나무_분류.ipynb` |
| **난이도** | ★★☆☆☆ (초급) |

#### 과제 내용
1. 특성(온도, 회전속도, 토크, 공구마모) 선택 및 타겟(Machine failure) 지정
2. 학습/테스트 데이터 8:2 분할
3. DecisionTreeClassifier(max_depth=3) 학습
4. plot_tree로 트리 시각화
5. 테스트 데이터 정확도 계산 및 의사결정 규칙 해석
