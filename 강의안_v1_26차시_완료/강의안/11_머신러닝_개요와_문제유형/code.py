"""
[11차시] 머신러닝 개요와 문제 유형 - 실습 코드
학습목표: 머신러닝 기본 개념 이해, 분류/회귀 구분, sklearn 기초
"""
...
# 결과 확인
print(f"\n실제값 (처음 5개): {list(y_test_r[:5].round(1))}")
