...
| 항목 | 내용 |
|------|------|
| **차시명** | 종합 프로젝트 발표 및 과정 총정리 |
| **학습목표** | - 최종 프로젝트 결과물을 발표하고 피드백을 주고받는다 |
| | - 26차시 전체 과정의 핵심 내용을 복습한다 |
| | - AI 분야 후속 학습 방향을 파악한다 |
| **학습내용** | - 조별/개인 프로젝트 발표 (제조 품질 예측 웹 서비스) |
| | - 동료 피드백 및 강사 코멘트 |
...
| 26 | 최종 과제 | 제조 품질 예측 웹 서비스 구축 (EDA → 모델링 → 서비스화) |
...
| **[4] 단계별 실습 학습** | 10~26차시 | 문제정의→데이터분석→모델링→평가→서비스화→발표 |
